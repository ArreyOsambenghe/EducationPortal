...
const createProgramFn: FunctionDeclaration = {
  ...
  parameters: {
    ...
    properties: {
      ...
      code: { type: SchemaType.STRING, description: 'Program code.' },
...
const createLevelFn: FunctionDeclaration = {
  ...
  parameters: {
    ...
    properties: {
      ...
      description: { type: SchemaType.STRING, description: 'Optional description.' },
      programId: { type: SchemaType.STRING, description: 'Program ID.' },
      code: { type: SchemaType.STRING, description: 'Level code.' },
    },
...
const createSemesterFn: FunctionDeclaration = {
  ...
  parameters: {
    ...
    properties: {
      ...
      code: { type: SchemaType.STRING, description: 'Semester code.' },
    },
