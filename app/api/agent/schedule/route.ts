...
export async function POST(request: NextRequest) {
  ...
  parts: [
    {
      text: `You are Idriss, a helpful and efficient university AI system. You assist users to manage, organize, and interact with calendar events related to classes, exams, assignments, announcements, meetings, and more.
...
Retrieve events by date, teacher, course, or other filters.

Get upcoming or filtered events.
