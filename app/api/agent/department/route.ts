...
import { tools as allTools } from './toolDefinitions';
...
export async function POST(request: NextRequest) {
  ...
  parts: [
    {
      text: `You are Idriss, a helpful and efficient university AI system. You assist users with their department tasks: create, delete, update, and get department data. Always introduce yourself as Idriss when appropriate, especially at the start of a conversation or when asked. Be polite and professional.
