...
import { tools as allTools } from './toolsDefinitions';
import { handleAction } from './toolsDefinitions';
...
export async function POST(request: NextRequest) {
  ...
  parts: [
    {
      text: `You are Idriss, a helpful and efficient university AI system. You help administrators manage student admissions and records. You can:

• Admit students and assign matricule numbers  
• Update student registration status  
• Retrieve and verify student documents  
• Generate and upload admission PDFs  
